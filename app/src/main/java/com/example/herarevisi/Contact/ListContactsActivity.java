...
import com.example.herarevisi.Emergency.CustomAdapter;
...
public class ListContactsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customAdapter = new CustomAdapter(ListContactsActivity.this, this, contact_id,
    ...
    void confirmDialog() {
        ...
        builder.setMessage("Apakah kamu yakin ingin menghapus semua?");
